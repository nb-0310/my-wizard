...
export class Erc1155Component {
  ...
  constructor(private clipboardService: ClipboardService, public deployerc1155Service: Deployerc1155Service) {}
  ...
  generateContract(): string {
    ...
    const contract: string = erc1155.print(this.contractParams as ERC1155Options);
  ...
  async deploy () {
    const res = await this.deployerc1155Service.deployERC721(this.contractParams)
